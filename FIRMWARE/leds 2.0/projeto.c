...
#define Ferramentax PORTCbits.RC0
#define Ferramentay PORTCbits.RC1
#define Ferramentaz PORTCbits.RC2
...
#define PWM_OUT PORTEbits.RE0
	//DISPLAY1
#define DATAa PORTDbits.RD4
#define DATAb PORTDbits.RD5
#define DATAc PORTDbits.RD6
#define DATAd PORTDbits.RD7
	//DISPLAY2
#define DATAe PORTDbits.RD0
#define DATAf PORTDbits.RD1
#define DATAg PORTDbits.RD2
#define DATAh PORTDbits.RD3
...
//Delay_ms(0.05);
          ...
          ferramentas_disp[8]=Ferramentax;
            ferramentas_disp[9]=Ferramentay;
           ferramentas_disp[10]=Ferramentaz;
...
for (is = 0; is<n_ferramentas; is++){
ferramentas_disp[is]=1;
}
