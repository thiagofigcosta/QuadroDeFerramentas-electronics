...
#define E_B7 TRISBbits.TRISB2=1;
#define S_B7 TRISBbits.TRISB2=0;
...
#define E_B4 TRISBbits.TRISB6=1;
#define S_B4 TRISBbits.TRISB6=0;

#define E  PORTCbits.RC7  //Define o nome E para a estrutra.
#define E_E TRISCbits.TRISC7=1;
#define S_E TRISCbits.TRISC7=0;
/*
#define RW PORTDbits.RD1//Define o nome RW para a estrutra.
#define E_RW TRISDbits.TRISD1=1;
#define S_RW TRISDbits.TRISD1=0;
*/
#define RS PORTAbits.RA5 //Define o nome RS para a estrutra.
#define E_RS TRISAbits.TRISA5=1;
#define S_RS TRISAbits.TRISA5=0;
...
void lcd_printchar(unsigned char dado)
{
...
void lcd_print(const rom char *s_caracteres)
{
        while (*s_caracteres!=0)
        {
                lcd_printchar(*s_caracteres);
                s_caracteres++;
        }
}
