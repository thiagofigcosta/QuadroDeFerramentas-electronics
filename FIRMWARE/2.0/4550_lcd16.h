...
#define B4 PORTCbits.RC7 //Define o nome B4 para a estrutra.
#define E_B4 TRISCbits.TRISC7=1;
#define S_B4 TRISCbits.TRISC7=0;

#define E  PORTAbits.RA5  //Define o nome E para a estrutra.
#define E_E TRISAbits.TRISA5=1;
#define S_E TRISAbits.TRISA5=0;
/*
#define RW PORTDbits.RD1//Define o nome RW para a estrutra.
#define E_RW TRISDbits.TRISD1=1;
#define S_RW TRISDbits.TRISD1=0;
*/
#define RS PORTBbits.RB7 //Define o nome RS para a estrutra.
#define E_RS TRISBbits.TRISB7=1;
#define S_RS TRISBbits.TRISB7=0;
